...
class Player(BasePlayer):
    ...
    control_1 = models.IntegerField(label="Durante el año 2021, ¿Usted ha consumido cigarrillos de forma habitual (por lo menos 1 cada 30 días)?", choices=[[0, "No"], [1, "Sí"]], widget=widgets.RadioSelect)
    control_2 = models.IntegerField(label="Durante el año 2020, ¿Usted ha consumido cigarrillos de forma habitual (por lo menos 1 cada 30 días)?", choices=[[0, "No"], [1, "Sí"]], widget=widgets.RadioSelect)
    control_3 = models.IntegerField(label="Antes del confinamiento (2019), ¿Usted ha consumido cigarrillos de forma habitual (por lo menos 1 cada 30 días)?", choices=[[0, "No"], [1, "Sí"]], widget=widgets.RadioSelect)
